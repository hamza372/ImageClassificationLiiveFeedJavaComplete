...
public class MainActivity extends AppCompatActivity implements ImageReader.OnImageAvailableListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            classifier = new Classifier(this,Classifier.Device.GPU,2,"mobilenet_v1_1.0_224.tflite","labels.txt");
        } catch (IOException e) {
            e.printStackTrace();
            Log.d("tryExc",e.getMessage());
        }
    ...
    private void processImage() {
        ...
        List<Classifier.Recognition> recognitionList = classifier.recognizeImage(rgbFrameBitmap,sensorOrientation);//classifier.recognizeImage(rgbFrameBitmap,getScreenOrientation());
        result = "";
